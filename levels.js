...
const levelLibrary = {
    ...
    3: {
        ...
        platforms: [
            ...
            { x: 200, y: 4750, width: 100, height: 15 }, // Moved platform left!
            { x: 500, y: 4600, width: 100, height: 15 }, // Shifted this right
            { x: 350, y: 4450, width: 80, height: 15, isCrumbling: true },
            { x: 200, y: 4300, width: 60, height: 15 },
            { x: 500, y: 4300, width: 60, height: 15 },
            { x: 350, y: 4100, width: 100, height: 20, isGoal: true }
        ],
        gems: [{ x: 380, y: 4400 }],
        hazards: [{ x: 235, y: 4735, width: 30, height: 15 }] // Spikes moved to the left platform
    },
    4: {
        theme: "matrix",
        platforms: [
            { x: 350, y: 4950, width: 150, height: 20 },
            { x: 200, y: 4800, width: 80, height: 15, patrolX: 100, speed: 1.5 },
            { x: 500, y: 4600, width: 80, height: 15 },
            { x: 300, y: 4400, width: 80, height: 15, patrolX: 80, speed: 2 },
    ...
    7: {
        ...
        platforms: [
            { x: 350, y: 4950, width: 150, height: 20 },
            { x: 450, y: 4800, width: 50, height: 15 },
    ...
    9: {
        ...
        platforms: [
            { x: 350, y: 4950, width: 150, height: 20 },
            { x: 250, y: 4800, width: 80, height: 15, patrolX: 150, speed: 2 }, // Lower moving platform
            { x: 150, y: 4650, width: 60, height: 15 }, // Left bridge platform
            { x: 370, y: 4550, width: 60, height: 15 }, // The center trap
            { x: 550, y: 4450, width: 60, height: 15 }, // Right bridge platform
            { x: 350, y: 4300, width: 80, height: 15, patrolX: 150, speed: 2.5 }, // Upper moving platform
            { x: 350, y: 4100, width: 150, height: 20, isGoal: true }
        ],
        hazards: [{ x: 370, y: 4535, width: 60, height: 15 }], // Spikes on the center trap
        sunstones: [{ x: 180, y: 4550 }], // Reward on the left
        gems: [{ x: 580, y: 4350 }] // Reward on the right
    },
    10: {
        theme: "ice",
        platforms: [
